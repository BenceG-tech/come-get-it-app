  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        const venueRes = await rest(`/venues?id=eq.${id}&select=id,name,address,description,phone_number,website_url,hero_image_url,image_url,rating,opening_hours,participates_in_points,points_per_visit`);
